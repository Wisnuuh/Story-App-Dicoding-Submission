...
dependencies {
    ...
    androidTestImplementation("androidx.test:core:1.5.0") //InstantTaskExecutorRule
    androidTestImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.8.1") //TestDispatcher
